<template>
  ...
  <!-- 联络我们页面 -->
    <div class="Cmsbg" v-if="NewcateId=='40112' || NewcateId=='50113'">
...
.PcContact .FormMain{
  ...
  .btn-default{
      ...
      float: right;
      background: #aa1638;
      // background: url('/images/pc/contac_btn.png') no-repeat center;
...
.PcContact .CmsContentbg{
  width: 100%;
  height: 100%;
  // background: url('/Images/pc/indexbg.jpg') no-repeat top center;
